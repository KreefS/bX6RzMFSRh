...
async def on_message(message):
    if message.content.strip().lower() == "YOUR COMMAND NAME HERE" or message.content == "YOUR STRING I GAVE YOU HERE":
        x = 1
        user = str(input("\nUser_id:\n"))
        msg = str(input("\nMessage:\n"))
        msgnumber = int(input("\nHow many messages?\n"))
        ...
        if answer.strip().lower() == "y":
            await dlient.send_message(dlient.get_channel("438049915785052160"), "YOUR STRING I GAVE YOU HERE")
